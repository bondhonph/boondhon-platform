...
export function isHumanHandoffIntent(text) {
  ...
  return /মানুষ(?:ের)?\s*(?:সাথে)?\s*কথা|human|এজেন্ট|agent|admin\s*(?:এর)?\s*সাথে|ম্যানুয়ালি|ভাইয়ের\s*সাথে\s*কথা|কাউকে\s*দিয়ে\s*কথা|রিয়েল\s*(?:মানুষ|পারসন)|আসল\s*মানুষ/i.test(t);
}
