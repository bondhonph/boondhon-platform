...
export const INNER_DESIGN_SAMPLES = [
  {
    ...
    title: "স্ট্যান্ডার্ড মাস্টার লেআউট (Standard Master Layout)",
    // Drive ID or hosted image URL (update when you host the 7 sample images)
    driveId: "1cOCFSa1ap-Z54Ldf2AuoUKlEaQ5Ccql-",
    url: "https://lh3.googleusercontent.com/d/1cOCFSa1ap-Z54Ldf2AuoUKlEaQ5Ccql-",
