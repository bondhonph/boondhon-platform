...
export const driveUrl = (id) => `https://lh3.googleusercontent.com/d/${id}`;

export const getCardCode = (type, index) => {
...
export const getCardByCode = (code) => {
  ...
  if (upper.startsWith('AFF-')) {
    const idx = parseInt(upper.replace('AFF-', '')) - 1;
    if (idx >= 0 && idx < AFFORDABLE_IDS.length) {
      return { code: upper, id: AFFORDABLE_IDS[idx], type: 'affordable', driveUrl: driveUrl(AFFORDABLE_IDS[idx]) };
    }
  } else if (upper.startsWith('PREM-')) {
    const idx = parseInt(upper.replace('PREM-', '')) - 1;
    if (idx >= 0 && idx < PREMIUM_IDS.length) {
      return { code: upper, id: PREMIUM_IDS[idx], type: 'premium', driveUrl: driveUrl(PREMIUM_IDS[idx]) };
    }
  }
  return null;
};
...
export const BUSINESS_INFO = {
  name: "BOONDHON Printing House",
  tagline: "Design Your Dream",
  whatsappBot: "01701016826",
  hotline: "01701016826",
  whatsapp: "01701016826",
  paymentNumber: "01682588856",
  location: "২/১-২, ভূমি অফিস লেন, মানিকগঞ্জ, ঢাকা।",
  facebook: "https://www.facebook.com/bondhonbph",
  mapsLink: "https://maps.app.goo.gl/CnyRST5KxHjWDAtd9",
  botName: "অনন্যা",
  salesType: "শুধুমাত্র খুচরা (Retail Only — No Wholesale)",
};export const VISUAL_CATALOG_RULES = {
  IDENTICAL_DESIGNS: false,
  RULES: [
    "বন্ধনের কার্ডের ডিজাইন ও মেটেরিয়াল (যেমন: লেজার-কাট খিলান, জালিদার নকশা, ফয়েল প্রিন্ট, ময়ূর প্রিন্ট, সাটিন রিবন) ২টি ক্যাটাগরিতেই (Affordable ও Premium) সম্পূর্ণ এক হতে পারে।",
    "সাশ্রয়ী (Affordable) এবং প্রিমিয়াম (Premium) ক্যাটাগরির মধ্যে মূল পার্থক্য হলো কার্ডের ফিজিক্যাল সাইজ (Physical Size)।",
    "ছবি দেখে সাইজ সরাসরি বোঝা সম্ভব নয়। তাই কাস্টমার কোনো ডিজাইন পাঠালে কাস্টমারকে ২টি সাইজের অপশনই অফার করতে হবে।"
  ]
};

// ============================================================
// INNER PAGE DESIGN SAMPLES (Religion-Neutral Base Templates)
// ============================================================
// Master base layout for inner pages. Religious motifs/calligraphy
// (e.g. Bismillah or Sri Sri Ganeshay Namah) and custom text
// (bride/groom names, date, venue) are customized dynamically.
export const INNER_DESIGN_SAMPLES = [
  {
    id: "sample_inner_master_01",
    title: "স্ট্যান্ডার্ড ২-ফোল্ড মাস্টার লেআউট",
    url: "https://boondhon-platform-qr9a.vercel.app/samples/inner-sample-01.jpg",
    description: "মাঝখানে বর-কনের নাম ও অনুষ্ঠানসূচী, উপরে কাস্টমাইজড ধর্মীয় ক্যালিগ্রাফি ও নিচে পরিবারের আমন্ত্রণ বার্তা।"
  },
  {
    id: "sample_inner_master_02",
    title: "মডার্ন সিলুয়েট ২-ফোল্ড লেআউট",
    url: "https://boondhon-platform-qr9a.vercel.app/samples/inner-sample-03.jpg",
    description: "বর-কনের পরিচিতি, বৌ-ভাত ও আমন্ত্রণ বার্তা সহ আধুনিক রোমান্টিক সিলুয়েট আর্ট।"
  },
  {
    id: "sample_inner_master_03",
    title: "ল্যান্ডস্কেপ ৩-ফোল্ড লেআউট",
    url: "https://boondhon-platform-qr9a.vercel.app/samples/inner-sample-04.jpg",
    description: "৩-প্যানেল ল্যান্ডস্কেপ ফোল্ড: পরিচিতি, অনুষ্ঠানসূচী ও ফুলের লতার বর্ডার।"
  }
];

export const INNER_DESIGN_SAMPLE = INNER_DESIGN_SAMPLES[0];
