...
// Send 8 Card Gallery: Send 8 photos sequentially and await completion before returning!
async function sendMessenger8CardGallery(recipientId, type = 'affordable', offset = 0) {
  ...
  // 1. Send all 8 photos sequentially with 300ms delay
      ...
      if (body.object === 'page') {
        ...
        for (const entry of entries) {
          ...
          if (webhookEvent) {
            ...
            // Skip ONLY if the message was generated BY our bot app itself (app_id: 2563899990649523)
        ...
        // Return 200 OK ONLY AFTER all messages have been sent to Meta!
