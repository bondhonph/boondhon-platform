function getFallbackReply(userText) {
  ...
  if (txt.includes('পাইকারি') || txt.includes('পাইকারী') || txt.includes('wholesale') || txt.includes('হোলসেল') || txt.includes('paikari') || txt.includes('ডিলার') || txt.includes('রিসেলার')) {
    return `দুঃখিত, আমরা পাইকারি বা হোলসেল (Wholesale) এ কার্ড বিক্রি করি না। 🌸\nআমরা শুধুমাত্র সরাসরি গ্রাহকদের জন্য খুচরা (Retail) কার্ড তৈরি ও সরবরাহ করে থাকি।\n\nআপনার নিজের অনুষ্ঠানের জন্য কত পিস কার্ড লাগবে জানালে আমাদের ডিজাইন ও মূল্য তালিকা জানাতে পারি! 😊`;
  }
...
পাইকারি/হোলসেল: আমরা কোনো পাইকারি বা হোলসেলে কার্ড বিক্রি করি না, শুধুমাত্র সরাসরি গ্রাহকদের জন্য খুচরা (Retail) বিক্রি করি। কেউ পাইকারি চাইলে বিনয়ের সাথে না বলবে এবং খুচরা রেট জানাবে।
