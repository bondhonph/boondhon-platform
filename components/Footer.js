        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li><a href="https://wa.me/8801701016826" target="_blank" rel="noreferrer" className="flex items-center gap-2 text-gray-400 hover:text-green-400 transition-colors"><MessageCircle size={14} className="text-green-400" />WhatsApp (বট)</a></li>
